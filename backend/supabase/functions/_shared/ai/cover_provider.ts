...
Create a polished restaurant-menu photograph with the dish as the clear hero. Put the geometric center of the serving vessel near the center of the frame, keep the entire vessel visible with balanced breathing room, and keep utensils beside the vessel or omit them instead of crossing over the dish. Use a simple clean tabletop or backdrop without decorative props. Remove unrelated table clutter, used tissues, printed paper, packaging, discarded shells or scraps, and distracting background objects. For menu_ready or editorial finishes, preserve the Source food but visibly transfer it from stained, disposable, casual, or visually weak Source ware into a clearly different pristine restaurant serving vessel; do not merely clean or reframe the same vessel. Every visible interior and exterior surface of the new vessel must have zero stains, sauce splashes, crumbs, food residue, chips, discoloration, or wear. Keep an existing cooking vessel only when it is essential to the dish's identity.
