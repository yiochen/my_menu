...
Future<void> showCoverHistorySheet(
  ...
  String dishId,
    ...
    showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) => _CoverHistorySheet(
        state: state,
        dishId: dishId,
      ),
    );

class _CoverHistorySheet extends StatelessWidget {
  const _CoverHistorySheet({required this.state, required this.dishId});
