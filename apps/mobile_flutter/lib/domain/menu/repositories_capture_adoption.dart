...
extension CaptureProposalAdoptionRepository on CaptureCorrectionRepository {
  Future<void> adoptValidatedCaptureRoutingProposal(
  ...
  Future<void> _recordRoutingCorrection({
    ...
    await _database.into(_database.captureCorrections).insertOnConflictUpdate(
          db.CaptureCorrectionsCompanion.insert(
            ...
            status: CaptureCorrectionStatus.applied.name,
            createdAt: now,
            updatedAt: now,
          ),
        );
